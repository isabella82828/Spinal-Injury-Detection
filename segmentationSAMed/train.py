...
parser.add_argument('--root_path', type=str,
                    default='../../train_npz/', help='root dir for data')
# parser.add_argument('--root_path', type=str,
                    # default=r'C:
parser.add_argument('--output', type=str, default='./output/samed_h/results')
...
parser.add_argument('--skip_hard', default=True, action='store_true', help='If activated, skip the hard example mining')
