...
if __name__ == '__main__':
    model = YOLO("C:/Users/Desktop/HematomaDetection/yolov8/runs/detect/train4/weights/best.pt")
    ...
    extract_coordinates("C:/Users/Desktop/HematomaDetection/yolov8/runs/detect/predict17/coordinates.csv", results)